...
_CONFIG_FOR_DOC = "PixelToTextEncoderDecoderModel"
...
class PixelToTextEncoderDecoderModel(PreTrainedModel):
    r"""
    ...
    """
    config_class = PixelToTextEncoderDecoderConfig
    base_model_prefix = 'pixel-to-text'
    ...
    def __init__(
        ...
        if config is None:
            config = PixelToTextEncoderDecoderConfig.from_encoder_decoder_configs(encoder.config, decoder.config)
        else:
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        config = PixelToTextEncoderDecoderConfig.from_encoder_decoder_configs(encoder.config, decoder.config, **kwargs)
